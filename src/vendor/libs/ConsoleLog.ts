...
export default class ConsoleLog implements IConsoleLog {
   ...
   * @param {true} [silent] Useful for hiding messages in certain scenarios without removing the function call, eg, silent mode. It does not apply to "log" and "debug" type.
